...
contextBridge.exposeInMainWorld('electron', {
  ...
  editColumn: (id: number, name: string) => ipcRenderer.invoke('favlist:column:edit', id, name),
  ...
  editRow: (id: number, newRow: Record<number, string>) => ipcRenderer.invoke('favlist:row:edit', id, newRow),
